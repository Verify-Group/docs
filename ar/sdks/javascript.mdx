...
description: ثبّت Verify Group TypeScript SDK الرسمي، وهيّئ العميل، واستدعِ نقاط نهاية KYC والمطالبات والأدلة والعقوبات باستخدام مساعدات ذات أنواع معرّفة.
---
