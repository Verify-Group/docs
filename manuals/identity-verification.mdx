...
<Card title="Watch the Individual KYC Walkthrough" icon="circle-play" href="https://www.youtube.com/watch?v=VC0u672Kzuw">
...
<iframe
  width="100%"
  height="420"
  src="https://www.youtube.com/embed/VC0u672Kzuw"
  title="Verify Group Platform Walkthrough"
  frameBorder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
  allowFullScreen
  style={{ borderRadius: '8px', marginTop: '8px', marginBottom: '8px' }}
/>
