...
description: Trigger AI voice analysis on call sessions, interpret stress and deception scores, and combine signals into a composite participant fraud score.
---
