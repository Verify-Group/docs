...
description: Installez le SDK TypeScript officiel Verify Group, initialisez le client et appelez les points de terminaison KYC, réclamations, preuves et sanctions avec des helpers typés.
---
