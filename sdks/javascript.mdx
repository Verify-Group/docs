...
description: Install the official Verify Group TypeScript SDK, initialize the client, and call KYC, claims, evidence, and sanctions endpoints with typed helpers.
---
