...
description: "Partially update a participant record by sending only the fields you want to change, such as contact details, identifiers, or custom metadata."
