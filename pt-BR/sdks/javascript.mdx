...
description: Instale o SDK oficial em TypeScript da Verify Group, inicialize o cliente e chame endpoints de KYC, sinistros, evidências e sanções com helpers tipados.
---
